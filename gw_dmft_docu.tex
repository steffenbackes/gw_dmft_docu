...
Being restricted only to the two-index susceptibility $\chi_{ij}$,
and assuming that only Hubbard- and Hund's terms of the interaction
are relevant like in section~\ref{sec:glocwloc_dc_factor}, 
we can simplify the equation for $s$
we can calculate the polarization elements as
\begin{align}
 s
\end{align}
