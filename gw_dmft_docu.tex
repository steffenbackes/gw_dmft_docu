...
screened interaction $W$ and truncated the series at first order. The resulting expression
is thus
\begin{align}
...
\end{align}
\cng{Is this exact?}
and approximate the nonlocal part by $GW$, while the local part is approximated by DMFT
\begin{align}
...
$\Psi^{GW}_{\mathrm{nonloc}}[G,W]$ and $\Psi^{DMFT}_{\mathrm{loc}}[G,W]$.

Let us start first with the local part: In general, 
$\Psi^{DMFT}_{\mathrm{loc}}[G,W]$ is a functional of the fully 
