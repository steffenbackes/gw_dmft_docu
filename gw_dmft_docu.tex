...
%
\end{align}
We now introduce the Eigenbasis $\ket{m},\ket{n},\ket{o},\ket{p}$, which results in the first term
\begin{align}
 \frac{1}{Z}\sum_{mnop} \exp{-\beta E_m} 
 &\theta_{t>0}\braket{m|c^{\dagger}_a(t) |n}\braket{n| c_b(t)|o}\braket{o| c^{\dagger}_c |p}\braket{p| c_d |m} \\
%
 =\frac{1}{Z}\sum_{mnop} \exp{-\beta E_m}
 &\theta_{t>0}\braket{m|\mathrm{e}^{i(E_m-E_n)t} c^{\dagger}_a |n}\braket{n|\mathrm{e}^{i(E_n-E_o)t} c_b |o}\braket{o| c^{\dagger}_c |p}\braket{p| c_d |m} \\
%
 =\frac{1}{Z}\sum_{mnop} \exp{-\beta E_m}
 &\theta_{t>0} \mathrm{e}^{i(E_m-E_o)t} \braket{m| c^{\dagger}_a |n}\braket{n| c_b |o}\braket{o| c^{\dagger}_c |p}\braket{p| c_d |m} \\
%
 =\frac{1}{Z}\sum_{mo} \exp{-\beta E_m}
 &\theta_{t>0} \mathrm{e}^{i(E_m-E_o)t} \braket{m| c^{\dagger}_a c_b |o}\braket{o| c^{\dagger}_c c_d |m} .
%
\end{align}
A Fourier transform to frequency space yields
\begin{align}
 \chi^>_{abcd}(\omega) 
 &= \frac{1}{Z}\sum_{mo} \exp{-\beta E_m} \braket{m| c^{\dagger}_a c_b |o}\braket{o| c^{\dagger}_c c_d |m} \int_{0}^{\infty} \exp{i(\omega+i\delta)t} \mathrm{e}^{i(E_m-E_o)t}   \, \mathrm{d}t \\
 %
 &= \frac{i}{Z} \sum_{mo} \exp{-\beta E_m} \frac{ \braket{m| c^{\dagger}_a c_b |o}\braket{o| c^{\dagger}_c c_d |m} }{ \omega+i\delta + E_m-E_o } .
 % 
\end{align}
...
\begin{align}
 &\frac{1}{Z}\sum_{mnop} \exp{-\beta E_m}
 \theta_{t<0}\braket{m|c^{\dagger}_c|n}\braket{n| c_d |o}\braket{o|c^{\dagger}_a(t) |p}\braket{p|c_b(t) |m}  \\
%
 =&\frac{1}{Z}\sum_{mnop} \exp{-\beta E_m}
 \theta_{t<0}\braket{m|c^{\dagger}_c|n}\braket{n| c_d |o}\braket{o|\mathrm{e}^{i(E_o-E_p)t} c^{\dagger}_a |p}\braket{p|\mathrm{e}^{i(E_p-E_m)t} c_b |m} \\
%
 =&\frac{1}{Z}\sum_{mo} \exp{-\beta E_m}\mathrm{e}^{i(E_o-E_m)t}
 \theta_{t<0}\braket{m|c^{\dagger}_c c_d |o}\braket{o| c^{\dagger}_a c_b |m} \\
%
 \stackrel{m\leftrightarrow o}{=} &\frac{1}{Z}\sum_{mo} \exp{-\beta E_o}\mathrm{e}^{i(E_m-E_o)t}
 \theta_{t<0}\braket{o|c^{\dagger}_c c_d |m}\braket{m| c^{\dagger}_a c_b |o}. 
%
\end{align}
A Fourier transform to frequency space yields
\begin{align}
 \chi^<_{abcd}(\omega) 
 &= \frac{1}{Z}\sum_{mo} \exp{-\beta E_o} \braket{m| c^{\dagger}_a c_b |o}\braket{o|c^{\dagger}_c c_d |m} \int_{-\infty}^{0} \exp{i(\omega-i\delta)t} \mathrm{e}^{i(E_m-E_o)t}   \, \mathrm{d}t \\
 %
 &= -\frac{i}{Z} \sum_{mo} \exp{-\beta E_o} \frac{ \braket{m| c^{\dagger}_a c_b |o}\braket{o|c^{\dagger}_c c_d |m} }{ \omega-i\delta + E_m-E_o } .
 % 
\end{align}
...
% %       - \frac{1}{6}\braket{(\Delta S)^3 }^{(0)} +  \frac{1}{24}\braket{(\Delta S)^4 }^{(0)} - ...
% \end{align}
% We assume that $\Delta S$ has the form
% \begin{align}
%  \Delta S &=\int  t \sum_{i\neq 0}\left(c^*_0c_i + c^*_ic_0 \right) \, \mathrm{d}\tau.
% \end{align}
% We will not write the time integral explicitly from now on for readability.
% So we have for the different terms
% \begin{align}
%  \Delta S &=  t \sum_{i\neq 0}\left(c^*_0c_i + c^*_ic_0 \right) \\
%  (\Delta S)^2 &=  t^2 \sum_{ij\neq 0}\left( c^*_0c_ic_jc^*_0  + c_0 c^*_i c^*_j c_0 
%                                         + 2 c^*_0c^*_ic_jc_0 \right) \\
% \end{align}
