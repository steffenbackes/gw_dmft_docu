...
\subsection{High-frequency correction for GW-DC 1}
...
\end{align}
We need to evaluate the following high-frequency form (orbital/spin etc indices
are suppressed)
\begin{align}
& -\frac{1}{\beta}\sum_j 
  \left( w_0 + \frac{w_2}{(i\nu_j)^2} \right)
...
\mathrm{e}^{-i\nu_j \Delta}.
\end{align}
Evaluating the terms analytically we get for the first term
\begin{align}
   -\frac{1}{\beta}\sum_j \frac{w_0}{i\omega_n-i\nu_j}\mathrm{e}^{-i\nu_j \Delta}
&= -\frac{w_0}{\beta}\sum_j \frac{1}{i\omega'_j}\mathrm{e}^{-(i\omega_n-i\omega'_j) \Delta} \\
&= -\frac{w_0}{\beta}\mathrm{e}^{-i\omega_n \Delta}\sum_j \frac{1}{i\omega'_j}\mathrm{e}^{i\omega'_j \Delta} \\
&= -\frac{w_0}{2}.
\end{align}


\subsection{High-frequency correction for GW-DC 2}
When evaluating the doublecounting factor
\begin{align}
\Sigma^{GW,DC} &= -G^{0,\mathrm{loc},L}W^{0,\mathrm{loc},L},
\end{align}
