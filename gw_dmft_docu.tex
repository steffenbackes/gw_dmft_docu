...
\begin{align}
 \Sigma_{loc}(\omega)
 &= \frac{U}{2} + \frac{U}{8}\left( \frac{1}{\omega+i\delta-3t} +  \frac{1}{\omega+i\delta+3t} \right) \\
 &= \frac{U}{2} + \frac{U}{4} \frac{\omega_{\delta} }{ \omega^2_{\delta} -(3t)^2}  \\
 %
 \Sigma_{inter}(\omega)
 &= \frac{U}{8} \left( \frac{1}{\omega+i\delta-3t} -  \frac{1}{\omega+i\delta+3t} \right)  \\
    &= \frac{U}{4} \frac{ 3t }{ \omega^2_{\delta} -(3t)^2}.
\end{align}
...
\begin{align}
 ...
 %
 &= \frac{ \left( t - \frac{U}{4} \frac{ 3t }{ \omega^2_{\delta} -(3t)^2} \right)^2 }
           {\omega_{\delta}- \frac{U}{4} \frac{\omega_{\delta} }{ \omega^2_{\delta} -(3t)^2} } \\
&= \frac{ t^2 -\frac{U}{2} \frac{ 3t^2 }{ \omega^2_{\delta} -(3t)^2}  + \frac{U^2}{16} \frac{ 9t^2 }{ ( \omega^2_{\delta} -(3t)^2 )^2 }  }
           {\omega_{\delta}- \frac{U}{4} \frac{  \omega_{\delta} }{  \omega^2_{\delta} -(3t)^2  }  } 
\end{align}
