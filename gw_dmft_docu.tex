...
we do in DMFT, the screened interaction parameters can be written as
\begin{align}
U^{\mathrm{scr}}_{ab}(i\nu_n) &= W_{abab}(i\nu_n) \\
%
...
All elements of the local polarization that are relevant can be conveniently
calculated from the scalar equation for the Hunds parameters
\begin{align}
 P_{ab}(i\nu_n) 
...
A comparison between the two different $W$ can be seen in Fig.~\ref{fig:W_loc_comparison}
