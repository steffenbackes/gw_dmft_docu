...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1\textwidth]{figs/results/SrVO3_gwdmft_bands.pdf} 
\end{center}
\caption{The spectral function for SrVO$_3$ within GW+DMFT with
the $G_{loc}W_{loc}$ doublecounting.
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=1\textwidth]{figs/results/FeSe_gwdmft_bands.pdf} 
\end{center}
\caption{The spectral function for FeSe within GW+DMFT with
the $G_{loc}W_{loc}$ doublecounting.
The green lines show the DFT dispersion}
