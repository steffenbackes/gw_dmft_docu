...
The analytic continuation becomes increasingly hard

\begin{figure}[t]
\includegraphics[width=1.0\textwidth]{figs/GW_maxent_diffSigma.pdf}
...
\begin{figure}[t]
\includegraphics[width=1.0\textwidth]{figs/GWDMFT_maxent_diffSigma.pdf}
...
factors to show the dependence on $\sigma$.}
