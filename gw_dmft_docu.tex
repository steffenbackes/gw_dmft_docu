...
This Hamiltonian preserves translational invariance, but breaks particle-hole symmetry.
...
%
 &(7) + \frac{1}{2}\sum_{i\neq j,\sigma\sigma'} \braket{jj|V|ij} c^{\dagger}_{j\sigma} c^{\dagger}_{j\sigma'} c_{j\sigma'} c_{i\sigma} 
  ...
  % =-\sum_{i\neq j,\sigma} U_{jjij} c_{i\sigma} c^{\dagger}_{j\sigma}   n_{j\bar{\sigma}} \\
%
 &(8) + \frac{1}{2}\sum_{i\neq j,\sigma\sigma'} \braket{jj|V|ji} c^{\dagger}_{j\sigma} c^{\dagger}_{j\sigma'} c_{i\sigma'} c_{j\sigma} 
  ...
  % =-\sum_{i\neq j,\sigma} U_{jjji} c_{i\sigma} c^{\dagger}_{j\sigma} n_{j\bar{\sigma}}.
\end{align}
...
\end{align}
% In the following we will always assume \textbf{real} wave functions.
