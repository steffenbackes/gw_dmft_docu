...
\begin{align}
 \mathcal{G}^{-1} = i\omega + \mu - \sum_{ij\neq 0} t_{i0} G^{(0)}_{ij} t_{j0},
\end{align}
...
\begin{align}
 \mathcal{G}^{-1} = i\omega + \mu - \sum_{ij\neq 0} t_{i0} t_{j0} \left( G_{ij} - \frac{G_{i0} G_{0j} }{G_{00}} \right).
\end{align}
This equation can be simplified assuming a local Selfenergy to obtain an effective Dyson equation
\begin{align}
 \mathcal{G}^{-1} &= i\omega + \mu - \sum_{ij\neq 0} t_{i0} t_{j0} \left( G_{ij} - \frac{G_{i0} G_{0j} }{G_{00}} \right) \label{eq:eff_dyson_for_bath} \\
 &= (G_{00})^{-1} + \Sigma.
\end{align}
...
\begin{align}
 \mathcal{G}^{-1} &= i\omega + \mu -  t_{01} t_{10} \left( G_{11} - \frac{G_{10} G_{01} }{G_{00}} \right) \\
...
&= i\omega + \mu -  \frac{t^2}{i\omega + \mu-\Sigma_{00} } .
\end{align}
