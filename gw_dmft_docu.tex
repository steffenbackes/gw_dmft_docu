...
\begin{align}
 \Sigma_{loc}(\omega)
 &= \frac{U}{2} + c_{loc}\left( \frac{1}{\omega+i\delta-3t} +  \frac{1}{\omega+i\delta+3t} \right) \\
 \Sigma_{inter}(\omega)
 &= c_{inter}\left( \frac{1}{\omega+i\delta-3t} -  \frac{1}{\omega+i\delta+3t} \right) 
\end{align}
...
\begin{align}
 ...
 %
 &= \frac{ \left( t - \frac{c_{inter}}{\omega_{\delta}-3t} +  \frac{c_{inter}}{\omega_{\delta}+3t} \right)^2 }
           {\omega_{\delta}- \frac{c_{loc}}{\omega_{\delta}-3t} -  \frac{c_{loc}}{\omega_{\delta}+3t} } \\
\end{align}
