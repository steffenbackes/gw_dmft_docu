...
is real!) (see Chapter \ref{sec:hf_corr_interaction} for important high-frequency correction!)
\begin{align}
...
can be evaluated analytically (derivation is commented out)
\begin{align}
...
\begin{align}
 \frac{2}{\beta} &\sum_{n=1}^{\infty} \frac{\mathcal{V} - \frac{c}{\nu^2_n}-\mathcal{U}(0)}{\nu_n}
                                        \sin(\nu_n\tau) \nonumber \\
%
& \hspace{2cm}=\frac{2}{\beta} \sum_{n=1}^{\infty}\left( [\mathcal{V} -\mathcal{U}(0)]\frac{\sin(\nu_n\tau)}{\nu_n}
                                          - c\frac{\sin(\nu_n\tau)}{\nu^3_n}\right) \\
%
& \hspace{2cm}= 2\left( 
            [\mathcal{V} -\mathcal{U}(0)] \frac{-1}{2\beta} \left( \tau -\frac{\beta}{2} \right) 
            -\frac{c}{12\beta}\left( \tau^3 - \frac{3}{2}\tau^2\beta + \frac{1}{2}\tau\beta^2 \right) 
   \right) \\ 
% %
% & \hspace{2cm}= \frac{1}{\beta}\left( 
%             [\mathcal{V} -\mathcal{U}(0)] \left( \frac{\beta}{2} -\tau \right) 
%             -\frac{c}{6}\left( \tau^3 - \frac{3}{2}\tau^2\beta + \frac{1}{2}\tau\beta^2 \right) 
%    \right) \\
% %
% & \hspace{2cm}= \frac{1}{\beta}\left( 
%             [\mathcal{V} -\mathcal{U}(0)] \left( \frac{\beta}{2} -\tau \right) 
%             -\frac{c}{6}\tau\left( \frac{\beta}{2}-\tau \right) (\beta-\tau)
%    \right) \\
%
& \hspace{2cm}= \frac{\beta -2\tau}{2\beta}\left( 
...
&= -\frac{2}{\beta} \sum_{n=1}^{N_{\nu}-1} \left(\mathcal{U}(i\nu_n)-\mathcal{V}+\frac{c}{\nu_n^2} \right)
                                        \frac{ \cos(\nu_n\tau)-1 }{\nu_n^2} \nonumber\\
 &\hspace{2cm} + \frac{\tau(\beta-\tau)}{2\beta}
          \left( \mathcal{V}-\mathcal{U}(0)
          -c\frac{ \tau(\beta - \tau)}{12} \right)\\
%
%
...
&= \frac{2}{\beta} \sum_{n=1}^{N_{\nu}-1} \left(\mathcal{U}(i\nu_n)-\mathcal{V}+\frac{c}{\nu_n^2} \right)
 ...
 & \hspace{2cm} +\frac{\beta -2\tau}{2\beta}\left( 
            \mathcal{V} -\mathcal{U}(0)
            -c\frac{\tau(\beta-\tau)}{6} \right)
\end{align}
Differentiating $K(\tau)$ w.r.t. $\tau$ indeed gives the correct expression for $K(\tau')$ (would have saved a lot of work...)
